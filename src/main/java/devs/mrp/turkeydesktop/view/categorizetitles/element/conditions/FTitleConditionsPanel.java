...
public class FTitleConditionsPanel {
    ...
    public static PanelHandler<TitleConditionsEnum, AWTEvent, FeedbackerPanelWithFetcher<TitleConditionsEnum, AWTEvent>> getHandler(JFrame frame, PanelHandler<?, ?, ?> caller, TitledLog titledLog) {
        return new TitleConditionsHandler(frame, caller, titledLog);
    }
